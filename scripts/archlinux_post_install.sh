...
sudo pacman -S base-devel bash-completion bashtop bat discord docker docker-compose dust fd firefox neofetch neovim noto-fonts noto-fonts-cjk noto-fonts-emoji ripgrep starship tar tokei ttf-fira-code unrar unzip zip wget
